...
def cadastrar_produto(produtos: dict, codigo: int):
    nome, categoria, preco, estoque, perecivel, descricao = ler_dados_produto()
    persistir_dados_produto(produtos, codigo, nome, categoria, preco, estoque, perecivel, descricao)
...
def ler_dados_produto():
    ...
    return nome, categoria, preco, estoque, perecivel, descricao
...
def persistir_dados_produto(produtos, codigo, nome, categoria, preco, estoque, perecivel, descricao):
    produtos[codigo] = (nome, categoria, preco, estoque, perecivel, descricao)
